...
DIS_IND_MEMBERSHIP_CACHE_BYTES="${DIS_IND_MEMBERSHIP_CACHE_BYTES:-512}"
DIS_IND_CLUSTER_CACHE="${DIS_IND_CLUSTER_CACHE:-lru}"
DIS_IND_CLUSTER_CACHE_BYTES="${DIS_IND_CLUSTER_CACHE_BYTES:-128}"
DIS_IND_VALUE_ID_HOT_ENTRIES="${DIS_IND_VALUE_ID_HOT_ENTRIES:-128}"
...
buffer_pool_size="${29}"
value_id_cache_policy="${30}"
membership_cache_policy="${31}"
...
common_env=(
    ...
    "DIS_IND_PRUNE_WHOLE_COUNTS_ENABLED=$prune_whole_counts_enabled"
    ...
    "DIS_IND_VALUE_ID_CACHE_POLICY=$value_id_cache_policy"
    "DIS_IND_MEMBERSHIP_CACHE_POLICY=$membership_cache_policy"
    ...
    "DIS_IND_CLUSTER_CACHE=$cluster_cache_policy"
